...
import { Play, Loader2, Mail, Lock, User as UserIcon, Eye, EyeOff } from 'lucide-react'
...
export function RegisterView() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // O backend cria um projeto de exemplo junto com a conta; o dashboard
      // já abre com esse conteúdo (banner de onboarding).
  ...
  return (
    <div className="grid min-h-screen place-items-center px-4 py-10">
      ...
      <div className="w-full max-w-sm">
        ...
        <h1 className="mt-8 text-center font-display text-4xl tracking-wide">CRIAR CONTA</h1>
        <p className="mt-1 text-center text-sm text-muted-foreground">
          Comece com um projeto de exemplo pronto pra explorar.
        </p>
